    ...
    for root, _, files in os.walk(main_folder):
        for file in files:
            if file.endswith('.zip'):
                ...
                extract_to = os.path.normpath(output_folder if output_folder else root)
                try:
...
if __name__ == "__main__":
    main_folder_path = os.path.normpath("C:/RA work/SEC Rule 605 Datasets/EXBL")  # Replace with your main folder path
    output_folder_path = os.path.normpath("C:/RA work/SEC Rule 605 Datasets/EXBL/unzip")  # Optional: Replace or set to None
